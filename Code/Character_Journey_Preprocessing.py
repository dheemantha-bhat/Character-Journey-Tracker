...
# file_path = 'Carnegie Mellon Corpuses/The Frog King, or Iron Henry.txt'
# file_path = 'Carnegie Mellon Corpuses/Our Lady\'s Child.txt'
# file_path = 'Carnegie Mellon Corpuses/The Story of a Youth Who Went Forth to Learn What Fear Was.txt'
# file_path = 'Carnegie Mellon Corpuses/The Wolf and the Seven Little Kids.txt'
file_path = 'Carnegie Mellon Corpuses/Faithful John.txt'
...
text_file_path = 'Cleaned_John.txt'
excel_file_path = 'Cleaned_John.xlsx'
